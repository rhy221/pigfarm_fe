      ...
      <table className="w-full table-fixed text-sm"> 
        <thead className="bg-[var(--color-muted)]">
          <tr className="divide-x divide-[var(--color-border)]/50">
            <th className="w-[80px] px-4 py-2 text-center text-sm font-semibold text-[var(--color-secondary-foreground)] uppercase">
              STT
            </th>
            <th className="w-[150px] px-4 py-2 text-center text-sm font-semibold text-[var(--color-secondary-foreground)]">
              Loại hóa chất
            </th>
