    ...
    <div className="overflow-x-auto border border-[var(--color-border)] rounded-lg bg-[var(--color-card)] shadow-sm">
      <table className="min-w-full divide-y divide-[var(--color-border)] table-auto">
        <thead className="bg-[var(--color-muted)]">
          <tr>
            <th className="w-16 px-4 py-3 text-center text-xs font-semibold uppercase">
              STT
            </th>
            <th className="w-48 px-4 py-3 text-center text-xs font-semibold uppercase">
              Tên người dùng
            </th>
            <th className="w-48 px-4 py-3 text-center text-xs font-semibold uppercase">
              Nhóm người dùng
            </th>
            <th className="w-64 px-4 py-3 text-center text-xs font-semibold uppercase">
              Email
            </th>
            <th className="w-48 px-4 py-3 text-center text-xs font-semibold uppercase">
              Mật khẩu
